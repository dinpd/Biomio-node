...
Schema.prototype.getAuthRequest = function (token, clientId, sessionId, resources, keyValueDict) {
...
Schema.prototype.getCancelAuthRequest = function (token, clientId, sessionId, resources, keyValueDict) {
  var request = this.RPC_REQUEST;
  request.header.token = token;
  request.msg.namespace = this.RPC_AUTH_CLIENT_NAMESPACE;
...
Schema.prototype.getGetUserRequest = function (token, clientId, sessionId, resources, keyValueDict) {
    var request = this.RPC_REQUEST;
    request.header.token = token;
