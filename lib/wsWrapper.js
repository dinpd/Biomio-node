...
Ws.prototype.sendAuthRequest = function(sessionId, clientId, resources) {
  var self = this;
  var request = self.schema.getAuthRequest(self.connectionData.token, clientId, sessionId, resources, {email: clientId, auth_code: 'NO_REST'})
  self.send(request);
};
