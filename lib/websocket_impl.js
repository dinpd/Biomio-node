...
exports.send_get_user_by_app_request = function (client_key) {
    connection_client._send_request(headers.get_rpc_get_user_by_app_request(connection_data.token, client_key,
        {client_key: client_key}));
};
