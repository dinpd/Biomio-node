  ...
  switch (message.msg.oid) {
    ...
    case 'rpcResp':
      ...
      if (self.is('_ready')) {
        ...
        var criteria = message.msg.session_id + '_' + message.msg.call;
...
Interface.prototype.rpc = function() {
  ...
  /* save callback */
  self.rpcCallbacks[sessionId + '_' + command] = callback;
  ...
  switch(command) {
    ...
    case 'cancel_auth':
      ...
      break;
    case 'get_user':
      self.ws.sendGetUserRequest(sessionId, userId, resources);
      break;
    case 'get_web_resource_secret':
