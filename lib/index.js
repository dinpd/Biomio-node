...
Interface.prototype.finish = function(sessionId) {
  var self = this;
  delete self.rpcCallbacks[sessionId + '_process_auth'];
  delete self.rpcCallbacks[sessionId + '_cancel_auth'];
  delete self.rpcCallbacks[sessionId + '_get_user'];
  delete self.rpcCallbacks[sessionId + '_get_web_resource_secret'];
};
