...
state_machine.init = function(options) {
  socket_client.init(options);
}
...
var message_listener = function (message) {
    ...
    } else if (parsed_message.msg.oid == 'getResources') {

        console.info('TODO: return resources!');
        socket_client.send_rpc_resources_request();
    } else if (parsed_message.msg.oid == 'try') {

        console.info('TODO: try!');
