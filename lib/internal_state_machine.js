...
state_machine.get_user = function (app_id, temp_callback) {
  pending_requests[app_id] = state_machine.get_user;
  if (typeof temp_callback != 'undefined' && temp_callback) {
    temp_keys_subscriptions[app_id] = temp_callback;
  }
  socket_client.send_get_user_request(app_id);
};
