...
state_machine.get_user_by_app = function (client_key, temp_callback) {
  pending_requests[client_key] = state_machine.get_user_by_app;
  if (typeof temp_callback != 'undefined' && temp_callback) {
    temp_keys_subscriptions[client_key] = temp_callback;
  }
  socket_client.send_get_user_by_app_request(client_key);
};
