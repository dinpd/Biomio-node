function Headers(options) {
  ...
  this.RPC_GET_USER_BY_APP = 'get_user_by_app';
...
Headers.prototype.get_rpc_get_user_by_app_request = function (token, client_key, keyValueDict) {
  var request = this.RPC_REQUEST;
  request.header.token = token;
  request.msg.namespace = this.RPC_AUTH_CLIENT_NAMESPACE;
  request.msg.call = this.RPC_GET_USER_BY_APP;
  request.msg.onBehalfOf = client_key;
  request.msg.data = {
    keys: [],
    values: []
